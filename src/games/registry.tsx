...
import PipePlumber from "./pipe-plumber/PipePlumber";
...
export const GAMES: GameEntry[] = [
  ...
  { slug: "pipe-plumber", title: "PIPE PLUMBER", genreKey: "pipe", color: C.blue, emblem: emblems.pipe, live: true, Component: PipePlumber, music: "/music-pipe.mp3" },
