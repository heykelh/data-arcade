  ...
  return (
    <main style={{ position: "relative", zIndex: 10, maxWidth: 760, margin: "0 auto", padding: "8px 16px 40px", color: C.ink }}>
      <div style={{ textAlign: "center", margin: "18px 0 6px" }}>
        ...
        <h1 style={{ fontFamily: PIX, fontSize: "clamp(22px, 8vw, 30px)", lineHeight: 1.25, margin: "16px 0 6px",
        ...
        {GAMES.map((game) => {
          const inner = (
            <>
              ...
              <div style={{ fontFamily: READ, fontSize: 16, color: C.dim, marginTop: 5 }}>{t.genres[game.genreKey]}</div>
      ...
      <p style={{ fontFamily: READ, fontSize: 18, color: C.dim, textAlign: "center",
        marginTop: 30, lineHeight: 1.4, maxWidth: 460, marginInline: "auto" }}>{t.hub.footer}</p>
    </main>
  );
}
